...
export const BulkActionBar: React.FC<BulkActionBarProps> = ({
  ...
  return (
    <div className="sticky top-0 z-20 bg-brand-600 text-white px-4 py-3 rounded-lg shadow-lg mb-4 flex flex-wrap items-center justify-between gap-3">
...
export const BulkActionButton: React.FC<BulkActionButtonProps> = ({
  ...
  const variantStyles = {
    default: 'bg-white text-brand-600 hover:bg-brand-50',
