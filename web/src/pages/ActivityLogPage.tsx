...
const ACTION_ICONS: Record<string, React.ComponentType<{ className?: string }>> = {
  ...
  raffle_ticket_marked_paid: DollarSign,
  raffle_ticket_voided: Ban,
  raffle_ticket_deleted: Trash2,
  raffle_prize_created: Gift,
  raffle_prize_updated: Edit,
  raffle_prize_deleted: Trash2,
  ...
  raffle_settings_updated: Settings,
...
const ACTION_COLORS: Record<string, string> = {
  ...
  raffle_ticket_marked_paid: 'bg-green-100 text-green-600',
  raffle_ticket_voided: 'bg-red-100 text-red-600',
  raffle_ticket_deleted: 'bg-red-100 text-red-600',
  raffle_prize_created: 'bg-blue-100 text-blue-600',
  raffle_prize_updated: 'bg-purple-100 text-purple-600',
  raffle_prize_deleted: 'bg-red-100 text-red-600',
  ...
  raffle_settings_updated: 'bg-purple-100 text-purple-600',
